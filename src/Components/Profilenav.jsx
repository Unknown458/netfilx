...
function Profilenav() {
  ...
  return (
    <>
      <div className="min-w-[230px]  border border-[#8080806b]   !important  bg-[#000000ec] rounded absolute z-20 top-[58px] right-[3px] drop">
              <div className="absolute z-20 right-[30px] -top-[1rem]"><BsCaretUpFill className="fill-white size-5"/></div>
            <ul className="px-2  py-4 flex flex-col gap-1 text-white">
              ...
              <li className="flex hover:underline items-center"> <span className="px-2 py-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" width="24" height="24" viewBox="0 0 24 24" role="img" data-icon="CircleQuestionMarkStandard" aria-hidden="true"><path fillRule="evenodd" clipRule="evenodd" d="M2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12ZM12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0ZM12 8C10.6831 8 10 8.74303 10 9.5H8C8 7.25697 10.0032 6 12 6C13.9968 6 16 7.25697 16 9.5C16 10.8487 14.9191 11.7679 13.8217 12.18C13.5572 12.2793 13.3322 12.4295 13.1858 12.5913C13.0452 12.7467 13 12.883 13 13V14H11V13C11 11.5649 12.1677 10.6647 13.1186 10.3076C13.8476 10.0339 14 9.64823 14 9.5C14 8.74303 13.3169 8 12 8ZM13.5 16.5C13.5 17.3284 12.8284 18 12 18C11.1716 18 10.5 17.3284 10.5 16.5C10.5 15.6716 11.1716 15 12 15C12.8284 15 13.5 15.6716 13.5 16.5Z" fill="currentColor"></path></svg></span> Help Center</li>

            
            </ul>
            <div onClick={()=>(console.log(signout()))}  className="flex items-center text-white w-full text-[0.9rem] justify-center border-t-[0.2px] border-[#8f8f8fdc] py-3 hover:underline">
                 Sign out of Netflix
              </div>
          </div>
    </>
